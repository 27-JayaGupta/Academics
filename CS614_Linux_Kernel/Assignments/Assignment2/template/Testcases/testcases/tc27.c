 ...
 * TC:Allocate big enough 2MB aligned region, then unmap big
*/
...
int main()
{
   ...
   unsigned long temp_addr = (unsigned long)ptr+1048576; //1MB 
   munmap((void *)temp_addr, 536870912); //512MB 
   temp_addr = (unsigned long)ptr+1074790400; //1GB+1MB
   munmap((void *)temp_addr, 536870912); //512MB
