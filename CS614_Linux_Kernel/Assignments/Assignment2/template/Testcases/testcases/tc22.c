 ...
 * TC:Allocated 2MB region, but no physical allocation
*/
...
int main()
{
   ...
   unsigned long src_addr = ((unsigned long)ptr+2097152)&~(0x1fffff);
   munmap((void *)ptr, SIZE);
   ptr = mmap((void*)src_addr, SIZE, PROT_READ|PROT_WRITE, MAP_ANONYMOUS|MAP_PRIVATE, 0, 0);
