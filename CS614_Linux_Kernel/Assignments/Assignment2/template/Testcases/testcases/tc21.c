 ...
 * TC:Allocate 2MB (aligned to 2MB boundry), check promotion
*/
...
int main()
{
   ...
   ptr = (char*)mmap(NULL, SIZE, PROT_READ, MAP_ANONYMOUS|MAP_PRIVATE, 0, 0);
   unsigned long src_addr = ((unsigned long)ptr+TWOMB)&~(0x1fffff);
   munmap((void *)ptr, SIZE);
   ptr = mmap((void*)src_addr, SIZE, PROT_READ|PROT_WRITE, MAP_ANONYMOUS|MAP_PRIVATE|MAP_POPULATE, 0, 0);
